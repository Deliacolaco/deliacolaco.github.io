...
Group project. My main contribution was Dashboard 2: Institutional Retention & Progress Insights, built for University Executives.
...
## Solution
The project delivered three connected outputs:

**Dashboard 1: Course & Unit Performance** — built for Course Directors to drill into unit-level fail rates, withdrawals, and cohort risk across their programs.

**Dashboard 2: Institutional Retention & Progress Insights** — built for University Executives to monitor retention trends, faculty performance, equity outcomes, and academic progress at an institutional level. This was my main contribution.

**Predictive model** — flags students most at risk of not continuing, using historical enrolment and academic data.
...
## Tools Used
**My contribution:** Qlik Sense

**Team-wide data preparation and modelling:** Python, Pandas, NumPy, Scikit-learn, XGBoost, Matplotlib
...
For both dashboards, every chart was built against a specific stakeholder use case. Filters and KPIs had to answer the question: what would the user do with this? If the answer wasn't clear, the chart didn't make it in.

## Design Choices on Dashboard 2
A few decisions on my dashboard worth flagging:
...
The 2025 plateau is a question, not an answer. The dashboards show it clearly, but they can't explain it. The next step would be pairing the data with surveys, exit interviews, or course feedback.
